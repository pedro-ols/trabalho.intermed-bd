...
('Cyberpunk', 'RPG', 'CD Project Red', 2020, 8.4),
...
('Dark Souls 2', 'RPG', 'From Software', 2014, 8.0),
('Dark Souls 3', 'RPG', 'From Software', 2016, 9.1),
('Bloodborne', 'RPG', 'From Software', 2015, 9.3),
('Sekiro', 'Ação', 'From Software', 2019, 8.9),
...
('Read Dead Redemption', 'Ação', 'Rockstar', 2010, 9.4),
('Read Dead Redemption 2', 'Acao', 'Rockstar', 2018, 9.7),
('GTA: San Andreas', 'Ação', 'Rockstar', 2004, 9.4),
('GTA: Vice City', 'Ação', 'Rockstar', 2002, 9.2),
('Max Payne', 'Ação', 'Rockstar', 2001, 9.2),
('Max Payne 2', 'Ação', 'Rockstar', 2003, 9.1),
('Max Payne 3', 'Acao', 'Rockstar', 2012, 8.6),
...
('Celeste', 'Plataforma', 'Maddy Makes Makes', 2018, 8.6),
...
SELECT * FROM jogos WHERE genero LIKE 'T%';
SELECT * FROM jogos WHERE genero LIKE 'T%' OR genero LIKE 'P%';
